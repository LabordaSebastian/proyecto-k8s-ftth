...
Para hacer el aprendizaje más realista, diseñé el laboratorio alrededor de un caso de uso común en la industria de las telecomunicaciones: **Una plataforma de aprovisionamiento y monitoreo para una red de fibra óptica (FTTH - Fiber To The Home)**.
...
*Gracias por pasarte por aquí. Si tienes sugerencias, ves algún área de mejora o quieres hablar sobre Kubernetes, no dudes en contactarme o abrir un issue en el repositorio.*
